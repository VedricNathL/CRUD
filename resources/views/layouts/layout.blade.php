                    ...
                    @if (Auth::check())
                        <li class="nav-item">
                            <a class="nav-link {{ Route::is('home') ? 'active' : '' }}" aria-current="page"
                                href="{{ route('home.page') }}">Dashboard</a>
                        </li>
                        @if (Auth::user()->role == 'admin')
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ route('medicines.index') }}">Data Obat</a>
                                    </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" {{ Route::is('pembelian') ? 'active' : '' }}" aria-current="page"
